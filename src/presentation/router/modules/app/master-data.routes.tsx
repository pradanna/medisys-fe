...
import HospitalInstallationPage from '@/presentation/pages/app/master-data/hospital-installation';
import HospitalUnitPage from '@/presentation/pages/app/master-data/hospital-unit';
